...
type ScAlphabetProgressYearly struct {
...
func (s *ScAlphabetProgressYearly) BeforeCreate(tx *gorm.DB) (err error) {
	if s.ID == "" {
...
func (ScAlphabetProgressYearly) TableName() string {
	return "sc_alphabet_progress_yearly"
}